...
public class WhitelistMenu implements InventoryHolder {
	...
	public void setupMenu(OfflinePlayer player) {
		...
		ItemStack removeBtn = setMeta(new ItemStack(Material.RED_WOOL), "Remove", null);
		ItemStack headBtn = setSkullMeta(new ItemStack(Material.PLAYER_HEAD), player);
		ItemStack addBtn = setMeta(new ItemStack(Material.GREEN_WOOL), "Add", null);
